...
def plot_histograms_from_file(histofile,
    ...
    histonames      : sequence
    List of the histogram name to be plotted,
...
def plot_histograms(histo_manager,
    ...
    ----------
    Arguments:
    histo_manager   : HistoManager object, optional
    It contains the histograms to be plotted.
    histonames      : sequence, optional
    List with histogram name to be plotted,
    if 'all', all histograms are plotted.
    n_columns       : int, optional
    Number of columns to distribute the histograms.
    plot_errors     : bool, optional
    If True, plot the associated errors instead of data.
    out_path        : string, optional
    Path to save the histograms in png. If not passed, histograms won't be saved.
    reference_histo : HistoManager object, optional
    It contains the histograms to be plotted as reference.
    normed          : bool, optional
